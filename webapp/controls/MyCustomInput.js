sap.ui.define([
	...
	"sap/ui/core/Icon"
		...
		"use strict";
		return Control.extend("CodeJam.controls.MyCustomInput", 
		{
			metadata : {
				properties : {
				...
				aggregations:{
				"_layout" : {type : "sap.ui.layout.Grid", multiple: false,
				visibility : "hidden"}
				}
			},
			init : function () {
				...
				that._oIcon.toggleStyleClass("sapThemePositiveText",
					that._oInput.getValue()!=="");
				that.setValue(that.oInput.getValue());
				});	
			}, 
